...
# --- SIDEBAR: TAG FILTERING (Tutor Req: 1) ---
with st.sidebar:
...
if uploaded_file and index:
    ...
    # 2. Generate Embedding (Live) [cite: 41]
    ...
    # 3. FAISS Search (Tutor Req: 3 - Optimization)
